...
- GitHub About (human, done 2026-09-05): the repo description now carries the README's one-line summary and the website points at https://pypi.org/project/lang-ai-agent/ (verified with `gh repo view`). Topics set on 2026-09-05 via `gh repo edit --add-topic`: ai-agent, fastapi, human-in-the-loop, langchain, langgraph, mcp, python, sse.
